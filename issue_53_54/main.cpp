...
void KNN1(float percentualTreino,float percentualTeste,int quantidadeDeClasses,int NumObjPorClasse[quantidadeDeClasses],float atributos,float objetos,Mat label,Mat atrib,int decision){
...
void KNN3(float percentualTreino,float percentualTeste,int quantidadeDeClasses,int NumObjPorClasse[quantidadeDeClasses],float atributos,float objetos,Mat label,Mat atrib,int decision){
    float acerto=0,erro=0;
    Mat Treino((objetos*(percentualTreino/100)),atributos+1,CV_32FC1);
    Mat Teste((objetos*(percentualTeste/100)),atributos+1,CV_32FC1);
    if (decision==1) {
...
void KNN5(float percentualTreino,float percentualTeste,int quantidadeDeClasses,int NumObjPorClasse[quantidadeDeClasses],float atributos,float objetos,Mat label,Mat atrib,int decision){
    float acerto=0,erro=0;
    Mat Treino((objetos*(percentualTreino/100)),atributos+1,CV_32FC1);
    Mat Teste((objetos*(percentualTeste/100)),atributos+1,CV_32FC1);
    if (decision==1) {
...
void KMEANS(float percentualTreino,float percentualTeste,int quantidadeDeClasses,int NumObjPorClasse[quantidadeDeClasses],float atributos,float objetos,Mat label,Mat atrib,int decision){
    float acerto=0,erro=0;
    Mat Treino((objetos*(percentualTreino/100)),atributos+1,CV_32FC1);
    Mat Teste((objetos*(percentualTeste/100)),atributos+1,CV_32FC1);
    if (decision==1) {
...
int main(){
    ...
    switch (selecione) {
        case 1:
            ...
            KNN1(perTreino, perTeste, quantidadeClasses, NumObjPorClasse, atributos, objetos, label, atrib,decision);
            break;
        case 2:
            //Escolher: Leave_on_out or Hold_out
            printf("Selecione:\n1-Leave_On_Out\n2-Hold-out\n");
            ...
            //SepararMatrizTreinoETeste
            PegarQuantidadeDeObjetoPorClasse(quantidadeClasses,NumObjPorClasse,objetos,label);
            KNN3(perTreino, perTeste, quantidadeClasses, NumObjPorClasse, atributos, objetos, label, atrib, decision);
            break;
        case 3:
            //Escolher: Leave_on_out or Hold_out
            printf("Selecione:\n1-Leave_On_Out\n2-Hold-out\n");
            ...
            //SepararMatrizTreinoETeste
            PegarQuantidadeDeObjetoPorClasse(quantidadeClasses,NumObjPorClasse,objetos,label);
            KNN5(perTreino, perTeste, quantidadeClasses, NumObjPorClasse, atributos, objetos, label, atrib, decision);
            break;
        case 4:
            //Escolher: Leave_on_out or Hold_out
            printf("Selecione:\n1-Leave_On_Out\n2-Hold-out\n");
            ...
            //SepararMatrizTreinoETeste
            PegarQuantidadeDeObjetoPorClasse(quantidadeClasses,NumObjPorClasse,objetos,label);
            KMEANS(perTreino, perTeste, quantidadeClasses, NumObjPorClasse, atributos, objetos, label, atrib, decision);
            break;
        default:
            printf("\nOpçao Invalida!\n");
            break;
