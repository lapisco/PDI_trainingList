...
FILE* file;
char address[500]="/Users/iMacPedrosa/Desktop/DataBase/numbersDB/num_padronizado_MomCent_OpenCv.txt";//Banco de dados - Carregar
char addressSave[500]="/Users/iMacPedrosa/Desktop/DataBase/DataBase_Normalized.txt";//Banco de dados normalizado - Salvar
...
void KNN(float percentualTreino,float percentualTeste,int quantidadeDeClasses,int NumObjPorClasse[quantidadeDeClasses],float atributos,float objetos,Mat label,Mat atrib,Mat Treino,Mat Teste,Mat TreinoLabel,Mat TesteLabel){
    //KNN
...
int main(){
    ...
    KNN(perTreino, perTeste, quantidadeClasses, NumObjPorClasse, atributos, objetos, label, atrib, Treino, Teste, TreinoLabel, TesteLabel);
}